...
def get_raw_data():
    ...
    data_path = path_util.get_movielens_raw_data_path()
...
def get_user_train_data(raw_data, user):
    ...
    timestamp = config_util.get_movielens_timestamp()
...
def get_user_mapping():
    json_path = os.path.join(path_util.get_movielens_preprocess_fp(), 'user_mapping.json')
    with open(json_path, 'r') as file:
...
def get_item_mapping():
    json_path = os.path.join(path_util.get_movielens_preprocess_fp(), 'item_mapping.json')
    with open(json_path, 'r') as file:
...
def get_user_with_train():
    json_path = os.path.join(path_util.get_movielens_preprocess_fp(), 'user_with_train.json')
...
def get_user_with_train_and_test():
    json_path = os.path.join(path_util.get_movielens_preprocess_fp(), 'user_with_train_and_test.json')
    with open(json_path, 'r') as f:
        data = json.load(f)
    return data
